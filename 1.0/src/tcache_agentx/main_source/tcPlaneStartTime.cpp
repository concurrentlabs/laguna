...
#define HANDLER_NAME "tcPlaneStartTime"

using namespace std;

static Netsnmp_Node_Handler tcPlaneStartTime_handler;

static void get_tcPlaneStartTime(string & s);

static void delayed_response(unsigned int clientreg, void * clientarg);

//********************************************************************************
// Function: init_tcPlaneStartTime
//
// Description: Control Plane Start Time initialization for mib.
//********************************************************************************
bool init_tcPlaneStartTime(void)
{
    syslog(LOG_DEBUG, "Enter: %s.", __FUNCTION__);

    static oid statusOID[] = { 1, 3, 6, 1, 4, 1, 1457, 4, 1, 1, 16 };

    netsnmp_handler_registration * reg{};
    reg = netsnmp_create_handler_registration(HANDLER_NAME,
        tcPlaneStartTime_handler, statusOID, OID_LENGTH(statusOID),
        HANDLER_CAN_RONLY);
    if(!reg)
    {
...
//********************************************************************************
// Function: tcPlaneStartTime_handler
//
// Description: Retrieve Control Plane Start Time.
//********************************************************************************
static int tcPlaneStartTime_handler(netsnmp_mib_handler * handler,
...
//********************************************************************************
// Function: get_tcPlaneStartTime
//
// Description: Retrieve StartTime value from Control Plane.
//********************************************************************************
static void get_tcPlaneStartTime(string & s)
{
